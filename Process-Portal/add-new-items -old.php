...
if($_POST['submit']=="Create New Invoice"){ 
    ...
    header("Location:upload-invoices.php?customer=".$_GET['customer'].""); 
}
...
if($_POST['update']=="Update"){ 
   ...
   for ($i=0; $i <$no ; $i++) { 
    ...
    header("Location:upload-invoices.php?customer=".$_GET['customer'].""); 
   // header("Location:customers.php?customer=".$_GET['customer']."&&invoice_no=".$_GET['invoice_no']);   
}
                             ...
                             <div class="col-md-12 tabbable-line boxless tabbable-reversed tab-content tab_0">
                                <div class="portlet box yellow">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-gift"></i><?php echo $_GET['invoice_no'];?>  : Add New Item
                                        </div>
                                    </div>
                                                           ...
                                                           foreach ($sql1 as $value) {           
                                                               if(in_array($value['name'], $tax)){
                                                                ...
                                                                <div class="col-md-1">        
                                                                    ...
                                                                    <input type="hidden" name="rate" class="tax_rate" value="<?php echo $value['rate'];?>">
                                                                </div>
                                                              <?php }else{ ?>
                                            ...
                                            <div class="form-body" id="containerItems">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        ?>
                                                        <span>SubTotal : </span><span class="subtotal"><?php echo $subTotal;?></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-body" id="containerItems">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <span>Total : </span><span class="total"><?php echo $subTotal;?></span>
                                                    </div>
                                                </div>
                                            </div>
