<?php 
    ...
    if($mcid!=0){
        ...
        $auditID        = generateAudit("SIM_ACPT", $mcid, $auditData, "");
        if($updateSim){

            /* Send Mail */
            $mailbox        = file_get_contents("partial-forms/alotted-sim-accept.html");
            ...
            $_SESSION["success"] = "Allotted Sim Successfully Accepted.";
