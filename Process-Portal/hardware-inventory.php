                             ...
                             <div class="col-lg-12 col-xs-12 col-sm-12">
                                 <div class="portlet box yellow">
                                     <div class="portlet-title">
                                         <div class="caption">
                                             <i class="fa fa-gift"></i>Hardware List
                                         </div>
                                         <div class="actions">
											 ...
											 <a class="btn green" href="/download-sim-inventory.php?tag=HARDWARE-INVENTORY">
        ...
        $(document).ready(function(){
            var tableParam = {
				...
				"columnDefs": [ {
				 ...
				 "order": [[ 1, "asc" ]],
                "ajax": './ajax/hardware-inventory-list.php',
                "scrollY":"100%"
            }
			...
			$("#Submit_LC").click(function(){
              $.ajax({
                ...
                url: "ajax/hardware-inventory-change-location.php",
