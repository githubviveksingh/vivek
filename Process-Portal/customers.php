...
?>
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                                     ...
                                     <div class="portlet-title">
										 ...
										 <div class="actions">
                                            <div class="btn-group btn-group-devided">
												...
												<label class="btn red" id="uploadXmlOption">
                                                   <i class="icon-cloud-upload"></i> Upload XML
												</label>
                                            </div>
                                        </div> 
                                     </div>
		...
		<!-- Upload XML file  --> 
		<div class="modal fade" id="UPLOADXML" role="dialog">
			<div class="modal-dialog" style="width:85% !important;">
			  <!-- Modal content-->
			  <div class="modal-content">
				<div class="modal-header">
				...
				<div class="modal-body">
				    <form id="xml-awesome-dropzone" class="dropzone" action="ajax/upload-xml-invoice.php" method="post">
				...
				<div class="modal-footer">				     
					 <a href="javascript:void(0);" class="btn btn-primary" id="formxmlsubmit" form-id="UPLOADXML">Submit</a>
                    <a href="javascript:;" id="closeXmlModal" class="btn btn-default pull-right closseModal">Close</a>
				</div>
				<div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-xs-12 col-sm-12">
        ...
        $("#uploadOption").click( function(){
        	...
        	/*  use to upload xml file */
        $("#closeXmlModal").click(function(){
                $("#UPLOADXML").modal("hide");
            })
        $("#uploadXmlOption").click( function(){
		...
		$(document).ready(function(){            
			Dropzone.options.myAwesomeDropzone = {
			  ...
			  /*  upload all customer invoices of xml file */
			   Dropzone.options.xmlAwesomeDropzone = {
                addRemoveLinks: true,
                init: function() {
                    var myDropzone = this;
                    document.getElementById("formxmlsubmit").addEventListener("click", function(e) {
                            var showme = myDropzone.files;
                            if (showme==""){
                                alert("Please choose xml file to upload");
                            }
                           // var validFlag = $("#UPLOADEXCEL").valid();
                            $("#aPurchaseType").val('20');
                            e.preventDefault();
                    ...
                    this.on("success", function(files, response) {
                       // alert(response);
                        ...
                        if(jsonRes.error.buyer){
							var length = Object.keys(jsonRes.error.buyer).length;
							for(var j = 0;j<length;j++){
								 var trHtml = "";
								
								trHtml += "<tr><td>"+jsonRes.error.buyer[j]+"</td><td>"+jsonRes.error.invoice[j]+"</td><td>"+jsonRes.error.error_type[j]+"</td></tr>";
							$(".errorTable tbody").append(trHtml);
							}
							return;
						}
