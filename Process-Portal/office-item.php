                             ...
                             <div class="col-lg-12 col-xs-12 col-sm-12">
                                 <div class="portlet box yellow">
                                     <div class="portlet-title">
                                         <div class="caption">
                                             <i class="fa fa-gift"></i>Office Items
                                         </div>
                                         <div class="actions">
											 ...
											 <a class="btn green" href="/download-sim-inventory.php?tag=OFFICE-ITEMS">
        ...
        $(document).ready(function(){
            var tableParam = {
                ...
                "processing": true,
				 ...
				 "order": [[ 1, "asc" ]],
                "ajax": './ajax/office-item-list.php',
                "scrollY":"100%"
            }
			...
			$("#Submit_LC").click(function(){
              $.ajax({
                ...
                url: "ajax/officeitem-change-location.php",
